...
if (filter_input(INPUT_SERVER, 'REQUEST_METHOD') === "GET") {
    ...
    if ($sanitizedEntries && $sanitizedEntries['filmID'] !== NULL && $sanitizedEntries['filmID'] !==
        ...
        $film = $utilisateursMgr->getMovieInformationsByID($filmID);
        // on récupère les cinémas qui ne projettent pas encore le film
        $cinemasUnplanned = $utilisateursMgr->getNonPlannedCinemas($filmID);
    }
...
require_once __DIR__ .'/views/viewMovieShowtimes.php';
?>